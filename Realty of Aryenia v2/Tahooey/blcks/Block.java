...
public class Block {
	...
	public void ChangeLayers() {
		if (directionOfSteps == UP) {
			...
			lower.setLocation(finalx + Engine.cam.x, finaly + (finalh / 2)
					+ Engine.cam.y);
		...
		if (directionOfSteps == DOWN) {
			...
			upper.setSize(finalw, finalh / 2);
			upper.setLocation(finalx + Engine.cam.x, finaly + (finalh / 2)
					+ Engine.cam.y);
		}
		if (directionOfSteps == LEFT) {
			...
			upper.setLocation(finalx + Engine.cam.x + (finalw / 2), finaly
					+ Engine.cam.y);
		}
		if (directionOfSteps == RIGHT) {
			lower.setSize(finalw / 2, finalh);
			lower.setLocation(finalx + (finalw / 2) + Engine.cam.x, finaly
					+ Engine.cam.y);
			upper.setSize(finalw / 2, finalh);
			upper.setLocation(finalx + Engine.cam.x, finaly + Engine.cam.y);
		}
